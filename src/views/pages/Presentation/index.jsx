	...
	return (
		<div className="presentation-item pt-9 px-8 pb-5 d-flex flex-column justify-space-between">
			<div className="head d-flex justify-space-between align-center">
				<div className="info">
					<h2 onClick={goToPresentation}>{name}</h2>
					{create_at}
				</div>
				<div className="image">
					<FileImageOutlined />
		...
		<>
				...
				<div className="container d-flex flex-column">
					...
					<section className="presentations mt-10">
						{presentations.map((item) => (
							<PresentationItem presentation={item} key={item.id} />
						))}
					</section>
				</div>
			</div>
			...
			>
				<form className="d-flex flex-column" onSubmit={formik.handleSubmit}>
					<label htmlFor="presentation-name-input">Nhập tiêu đề <span style={{ color: '#36B5B0' }}>*</span></label>
					<input
					...
					<label htmlFor="presentation-desc-input">Chọn loại presentaion: <span style={{ color: '#36B5B0' }}>*</span></label>
					<Radio.Group
						name="type"
					...
					<label htmlFor="presentation-in-group-input">Chọn nhóm chứa presentation <span style={{ color: '#36B5B0' }}>*</span></label>
					<select
